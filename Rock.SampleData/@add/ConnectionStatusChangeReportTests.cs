    ...
    public class ConnectionStatusChangeReportTests
    {
        ...
        public void AddConnectionStatusChangeHistoryTestData()
        {
            ...
            foreach ( var person in personList )
            {
                ...
                HistoryService.SaveChanges( dataContext, typeof( Person ), SystemGuid.Category.HISTORY_PERSON_DEMOGRAPHIC_CHANGES.AsGuid(), person.Id, historyChanges, true, adminPerson.PrimaryAliasId, _TestDataSourceOfChange );
            }
