...
namespace RockWeb.Blocks.Core
{
    ...
    public partial class BinaryFileDetail : RockBlock, IDetailBlock
    {
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            if ( !Page.IsPostBack )
            {
                ShowDetail( PageParameter( PageParameterKey.BinaryFileId ).AsInteger(), PageParameter( PageParameterKey.BinaryFileTypeId ).AsIntegerOrNull() );
        ...
        protected void btnEditLabelContents_Click( object sender, EventArgs e )
        {
            if ( fsFile.BinaryFileId.HasValue )
            {
                NavigateToLinkedPage( AttributeKey.EditLabelPage, new Dictionary<string, string> { { PageParameterKey.BinaryFileId, fsFile.BinaryFileId.Value.ToString() } } );
            }
        }
